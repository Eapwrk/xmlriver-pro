...
from xmlriver_pro.google import GoogleClient, GoogleSearch, GoogleNews, GoogleImages, GoogleMaps, GoogleAds
from xmlriver_pro.core.types import SearchResponse, SearchResult, TimeFilter, DeviceType
...
class TestGoogleMaps:
    ...
    def test_search_maps(self, mock_request):
        ...
        result = self.maps.search_maps("cafe moscow", zoom=12, coords=(55.7558, 37.6176))
...
class TestGoogleAds:
    ...
    def test_count_ads(self, mock_request):
        ...
        mock_response = {
            'topads': {
                'query': [{'url': 'ad1', 'adsurl': 'url1', 'title': 'Ad 1', 'snippet': 'Desc 1'}]
            },
            'bottomads': {
                'query': [{'url': 'ad2', 'adsurl': 'url2', 'title': 'Ad 2', 'snippet': 'Desc 2'}]
            }
        }
        mock_request.return_value = mock_response
