...
from xmlriver_pro.core.exceptions import (
    XMLRiverError, APIError, NetworkError, 
    AuthenticationError, RateLimitError,
    NoResultsError, ValidationError, get_error_message, raise_xmlriver_error
)
...
class TestGetErrorMessage:
    ...
    def test_get_known_error_message(self):
        ...
        assert message == "Для заданного поискового запроса отсутствуют результаты поиска"
